...
window.onload = function() {
    ...
    container.onfocus = function(){ container.style.opacity=0.7 }
    crtdv_img_box.appendChild(container)
...
function img_box(self) {
    ...
    img_img_box.onload = function() {
        ...
        if (wimg_img_box > wwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.width = '100%'
        }
        else if (himg_img_box > hwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.height = '100%'
            himg_img_box = hwin_img_box * 100 / 100
        }
